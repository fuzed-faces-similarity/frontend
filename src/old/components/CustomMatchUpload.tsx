...
import { Upload, Users, Heart } from "lucide-react";
...
export const CustomMatchUpload = ({ onSelectCustomMatch, selectedCustomMatch }: CustomMatchUploadProps) => {
  ...
  return (
    <Card className="p-4 sm:p-6 bg-gradient-card shadow-soft border-0 hover:shadow-match transition-all duration-300">
      <div className="text-center mb-4 sm:mb-6">
        ...
        <h2 className="text-xl sm:text-2xl font-display font-bold text-foreground mb-2">Upload Custom Photos</h2>
        <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">Upload photos of friends, family, or anyone from your camera roll!</p>
      </div>
      ...
      <div className="space-y-4 mb-6">
        ...
        >
          ...
          <div className="space-y-2">
            <p className="text-base font-medium text-foreground">Drag & drop photos here</p>
      ...
      {uploadedMatches.length > 0 && (
        <div className="space-y-3 sm:space-y-4">
          <h3 className="text-lg font-display font-semibold text-foreground">Your Uploaded Photos</h3>
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1 sm:mb-2">
                      <h3 className="font-bold text-foreground text-sm sm:text-base truncate">{match.name}</h3>
      ...
      {uploadedMatches.length === 0 && (
        <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-blue-50 rounded-lg border border-blue-200">
          <p className="text-xs sm:text-sm text-blue-700 text-center leading-relaxed">
            💡 Upload photos of friends, family, or anyone to see what your babies would look like together!
          </p>
        </div>
      )}
    </Card>
