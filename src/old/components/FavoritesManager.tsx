...
import { storage, FavoriteMatch, GeneratedBaby } from "@/lib/storage";
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-hidden">
        ...
        <Tabs defaultValue="favorites" className="flex-1">
          ...
          <TabsContent value="favorites" className="mt-4 max-h-96 overflow-y-auto">
            {favorites.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">
                <Heart className="w-12 h-12 mx-auto mb-3 opacity-50" />
                <p>No favorites yet</p>
                <p className="text-sm">Add favorites by clicking the heart icon on matches</p>
              </div>
            ) : (
